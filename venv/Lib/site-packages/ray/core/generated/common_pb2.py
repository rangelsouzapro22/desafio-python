...
_WORKERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='IO_WORKER', index=2, number=2,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
