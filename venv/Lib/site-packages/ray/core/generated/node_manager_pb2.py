...
_WORKERSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='worker_id', full_name='ray.rpc.WorkerStats.worker_id', index=4,
      ...
      serialized_options=None, json_name='workerId', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='language', full_name='ray.rpc.WorkerStats.language', index=5,
...
_GETNODESTATSREPLY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='pid', full_name='ray.rpc.GetNodeStatsReply.pid', index=5,
...
_WORKERSTATS.fields_by_name['language'].enum_type = src_dot_ray_dot_protobuf_dot_common__pb2._LANGUAGE
